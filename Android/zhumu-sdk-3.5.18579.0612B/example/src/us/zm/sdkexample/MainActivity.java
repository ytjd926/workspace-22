...
public class MainActivity extends Activity implements Constants,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mEdtXingming = (EditText) findViewById(R.id.xingming);
...
//		mEdtMeetingNo.setText(meet_num);
		...
		String xingming = mEdtXingming.getText().toString().trim();
		if (meetingNo.length() == 0 || xingming.length()==0) {
			Toast.makeText(
					this,
		...
		if(now.getMonth()!=6){
			...
			Toast.makeText(this, "授权已过期",	 Toast.LENGTH_LONG).show();
			return;
		}
		...
		int ret = meetingService.joinMeeting(this, meetingNo, xingming, opts);
